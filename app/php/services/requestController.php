...
function getBuyerRequestsController($inputData){
    $connection  = connect();
    /*$username = $inputData-> username;subCategory*/
    $category = $inputData-> category;
    $subCategory = $inputData-> subCategory;
    $query = "SELECT * FROM `buyer_request` WHERE sub_category_id = $subCategory ";
    $response = getData($connection, $query);
    echo $response;
}

function getBuyerRequestDataController($inputData){
    $connection  = connect();
    $buyerRequestId = $inputData-> buyerRequestId;
    $query = "SELECT * FROM `buyer_request` WHERE buyer_request_id = $buyerRequestId ";
    $response = getData($connection, $query);
    echo $response;
}
